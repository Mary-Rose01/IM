        ...
        <div class="card-body">
            <form method="post" id="orgForm">
                ...
                <div style="margin-top:20px;display:flex;gap:10px;">
                    ...
                    <button type="button" onclick="showConfirmModal('organizations.php', 'Discard Changes', 'Are you sure you want to leave? Any unsaved changes will be lost.')" class="btn btn-outline">Cancel</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" onclick="showConfirmModal('?action=delete&id=<?php echo $row['OrgID']; ?>', 'Delete Organization', 'Are you sure you want to delete <strong><?php echo htmlspecialchars(addslashes($row['OrgName'])); ?></strong>? This action cannot be undone.')" class="btn btn-danger btn-sm" style="margin-left:4px;"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php endwhile; else: ?>
...
function validateAndShowModal() {
    ...
    showConfirmModal('SUBMIT_FORM', isEdit ? 'Update Organization' : 'Add Organization',
        isEdit ? 'Are you sure you want to update this organization?' : 'Are you sure you want to add this new organization?',
        'btn-primary');
}
function showConfirmModal(url, title, message, btnClass = 'btn-danger') {
    ...
    if (url === 'SUBMIT_FORM') {
        ...
        confirmBtn.onclick = () => document.getElementById('orgForm').submit();
    } else {
        confirmBtn.href = url;
